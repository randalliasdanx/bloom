          ...
          <div className="space-y-4">
            <div>
              ...
              <Slider
                ...
                step={0.05}
                value={[exaggeration]}
                onValueChange={(values : any) => onExaggerationChange(values[0])}
                className="w-full"
              />
            ...
            <div>
              ...
              <Slider
                ...
                step={0.05}
                value={[cfgWeight]}
                onValueChange={(values : any) => onCfgWeightChange(values[0])}
                className="w-full"
              />
            ...
            <div>
              ...
              <Slider
                ...
                step={0.05}
                value={[temperature]}
                onValueChange={(values : any) => onTemperatureChange(values[0])}
                className="w-full"
              />
